...
YOUR_TOPICS = [
    # ── JESSICA · TOFU ───────────────────────────────────────────────────────
    ("J-T01", "jessica", "tofu", "Quanto uma manicure perde por mês com agenda bagunçada",         "reels",     ["instagram"], "numero"),
    ("J-T02", "jessica", "tofu", "A rotina real de uma manicure autônoma num dia cheio",             "reels",     ["instagram"], "promessa"),
    ("J-T03", "jessica", "tofu", "3 sinais de que seu atendimento está crescendo",                  "carrossel", ["instagram"], "promessa"),
    ("J-T04", "jessica", "tofu", "Por que manicure autônoma trabalha muito e sobra pouco",          "reels",     ["instagram"], "numero"),
    ("J-T05", "jessica", "tofu", "Como parecer mais profissional sem gastar nada",                  "card",      ["instagram"], "dor"),
    ("J-T06", "jessica", "tofu", "O erro que faz manicure perder cliente fiel sem entender por quê","reels",     ["instagram"], "erro"),
    ("J-T07", "jessica", "tofu", "5 coisas que toda manicure profissional faz diferente",           "carrossel", ["instagram"], "promessa"),
    ("J-T08", "jessica", "tofu", "Quanto vale a hora de uma manicure autônoma",                     "card",      ["instagram"], "numero"),
    # ── JESSICA · MOFU ───────────────────────────────────────────────────────
    ("J-M01", "jessica", "mofu", "Como acabar de vez com o no-show sem brigar com cliente",         "reels",     ["instagram"], "numero"),
    ("J-M02", "jessica", "mofu", "Como cobrar sinal sem perder cliente — script pronto",            "carrossel", ["instagram"], "promessa"),
    ("J-M03", "jessica", "mofu", "Como organizar a agenda da semana em 10 minutos na segunda",      "reels",     ["instagram"], "dor"),
    ...
    ("J-M06", "jessica", "mofu", "Como montar uma lista de espera e nunca ficar sem cliente",       "reels",     ["instagram"], "promessa"),
    ("J-M07", "jessica", "mofu", "Como fidelizar cliente de manicure — o que realmente funciona",  "card",      ["instagram"], "numero"),
    # ── JESSICA · BOFU ───────────────────────────────────────────────────────
    ("J-B01", "jessica", "bofu", "Agendamento online para manicure: como funciona na prática",      "reels",     ["instagram"], "promessa"),
    ...
    ("J-B05", "jessica", "bofu", "Quanto tempo você perde por semana gerenciando pelo WhatsApp",    "card",      ["instagram"], "numero"),
    # ── CARLA · TOFU ─────────────────────────────────────────────────────────
    ("C-T01", "carla",   "tofu", "Por que dona de salão trabalha 12h e ainda sente que está devendo","reels",   ["instagram"], "dor"),
    ("C-T02", "carla",   "tofu", "Como organizar a rotina do salão quando você é dona, profissional e caixa","carrossel",["instagram"], "dor"),
    ("C-T03", "carla",   "tofu", "3 sinais que seu salão está crescendo — mesmo que pareça o contrário","card", ["instagram"], "promessa"),
    ("C-T04", "carla",   "tofu", "A conta que toda dona de salão precisa fazer todo mês",           "reels",     ["instagram"], "erro"),
    ("C-T05", "carla",   "tofu", "Como contratar profissional sem quebrar o salão no primeiro mês", "reels",     ["instagram"], "numero"),
    ("C-T06", "carla",   "tofu", "Por que clientes do salão somem depois de 3 meses",               "carrossel", ["instagram"], "dor"),
    ("C-T07", "carla",   "tofu", "Quanto um salão pequeno precisa faturar para ser lucrativo",      "card",      ["instagram"], "numero"),
    ("C-T08", "carla",   "tofu", "O erro mais caro que donos de salão cometem no primeiro ano",     "reels",     ["instagram"], "erro"),
    # ── CARLA · MOFU ─────────────────────────────────────────────────────────
    ("C-M01", "carla",   "mofu", "Como calcular comissão de cabeleireiro sem errar nem prejudicar o salão","carrossel",["instagram"], "numero"),
    ("C-M02", "carla",   "mofu", "Como o no-show destrói o financeiro do salão — com números reais","reels",    ["instagram"], "numero"),
    ...
    ("C-M05", "carla",   "mofu", "Como criar uma escala de trabalho justa para a equipe do salão",  "reels",     ["instagram"], "erro"),
    ("C-M06", "carla",   "mofu", "Como precificar serviços do salão sem perder cliente nem lucro",  "card",      ["instagram"], "erro"),
    ...
    ("L-T04", "leo",     "tofu", "Fila de espera ou agendamento: qual modelo faz barbearia ganhar mais","reels", ["instagram"], "numero"),
    ("L-T05", "leo",     "tofu", "Por que barbeiro pede demissão — e como manter o melhor da equipe","carrossel",["instagram"], "dor"),
    ("L-T06", "leo",     "tofu", "Como organizar o dia a dia da barbearia sem depender de anotação", "reels",     ["instagram"], "erro"),
    ("L-T07", "leo",     "tofu", "Quanto custa abrir uma barbearia — planilha real de investimento", "card",      ["instagram"], "numero"),
    ...
    ("L-M02", "leo",     "mofu", "Como fidelizar cliente na barbearia — o que funciona de verdade",  "reels",     ["instagram"], "numero"),
    ("L-M03", "leo",     "mofu", "Como controlar o estoque de produtos da barbearia sem surpresa",   "card",      ["instagram"], "dor"),
    ("L-M04", "leo",     "mofu", "Como lidar com barbeiro que traz os próprios clientes e quer sair","reels",     ["instagram"], "dor"),
